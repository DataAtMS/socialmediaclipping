...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "clipping-tactics": { metaTitle: 'clipping tactics | Clipping for Ecommerce', metaDescription: 'Browse 5 articles about clipping tactics on Clipping for Ecommerce.', h1: 'clipping tactics', intro: 'Browse 5 articles about clipping tactics on Clipping for Ecommerce.' },
  "social-media-content": { metaTitle: 'social media content | Clipping for Ecommerce', metaDescription: 'Browse 5 articles about social media content on Clipping for Ecommerce.', h1: 'social media content', intro: 'Browse 5 articles about social media content on Clipping for Ecommerce.' },
  "instagram-content": { metaTitle: 'instagram content | Clipping for Ecommerce', metaDescription: 'Browse 5 articles about instagram content on Clipping for Ecommerce.', h1: 'instagram content', intro: 'Browse 5 articles about instagram content on Clipping for Ecommerce.' },
  "youtube-shorts": { metaTitle: 'youtube shorts | Clipping for Ecommerce', metaDescription: 'Browse 5 articles about youtube shorts on Clipping for Ecommerce.', h1: 'youtube shorts', intro: 'Browse 5 articles about youtube shorts on Clipping for Ecommerce.' },
  "tiktok-content-strategy": { metaTitle: 'tiktok content strategy | Clipping for Ecommerce', metaDescription: 'Browse 5 articles about tiktok content strategy on Clipping for Ecommerce.', h1: 'tiktok content strategy', intro: 'Browse 5 articles about tiktok content strategy on Clipping for Ecommerce.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://socialmediaclipping.com/' + slug;
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://socialmediaclipping.com' },

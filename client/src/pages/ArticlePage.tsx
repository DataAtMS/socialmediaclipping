...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Clipping for Ecommerce';
    ...
    const pageUrl = 'https://socialmediaclipping.com/articles/' + article.slug;
    const catUrl = 'https://socialmediaclipping.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Clipping for Ecommerce' },
      "publisher": { "@type": "Organization", "name": 'Clipping for Ecommerce', "url": 'https://socialmediaclipping.com' },
      "url": pageUrl,
    });
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link href="/"><span style={{ color: "#d2cd32", fontFamily: "monospace", fontSize: "12px", cursor: "pointer" }}>← BACK TO HOME</span></Link>
        </div>
      </div>
    );
  }
    ...
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body, overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(24px, 5vw, 64px)", display: "flex", gap: "48px", alignItems: "flex-start" }}>
        ...
        <article style={{ flex: 1, minWidth: 0, padding: "48px 0 80px" }}>
          ...
          {/* Category badge */}
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: "10px", color: COLOR.accent, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "16px" }}>
            {article.category}
          </div>
